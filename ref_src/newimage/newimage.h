...
class  fileFormats {
public:
  static const vector<pair<string,int> > allFormats() {
    const pair<string,int> allOutputFormats[10] = {
      pair<string,int>("ANALYZE",FSL_TYPE_ANALYZE),
      pair<string,int>("ANALYZE_GZ",FSL_TYPE_ANALYZE_GZ),
      pair<string,int>("NIFTI",FSL_TYPE_NIFTI),
      pair<string,int>("NIFTI_GZ",FSL_TYPE_NIFTI_GZ),
      pair<string,int>("NIFTI_PAIR",FSL_TYPE_NIFTI_PAIR),
      pair<string,int>("NIFTI_PAIR_GZ",FSL_TYPE_NIFTI_PAIR_GZ),
      pair<string,int>("NIFTI2",FSL_TYPE_NIFTI2),
      pair<string,int>("NIFTI2_GZ",FSL_TYPE_NIFTI2_GZ),
      pair<string,int>("NIFTI2_PAIR",FSL_TYPE_NIFTI2_PAIR),
      pair<string,int>("NIFTI2_PAIR_GZ",FSL_TYPE_NIFTI2_PAIR_GZ),
    };
    vector<pair<string,int> > formats(10);
    for(int i=0;i<10;i++)
...
#pragma interface
  ...
  private:
   ...
   int64_t no_voxels;
    ...
    int readGeneralVolume(volume<S>& target, const string& filename,
